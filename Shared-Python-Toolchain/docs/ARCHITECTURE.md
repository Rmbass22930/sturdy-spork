...
7. **security_gateway/service.py**
   ...
   - Detection-content refresh/import routes require operator authorization via a bearer token, with an explicit loopback-only fallback for local-only development.
