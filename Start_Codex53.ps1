# Start_Codex53.ps1
# Launch Codex 5.3 in this folder with the same resilient auth workflow as 5.4.
...
# Prefer shared user Codex home unless project-scoped auth is requested.
...
if (-not $codexCommand) {
  Write-Error "Codex CLI not found on PATH. Install/update Codex CLI, then run Start_Codex53 again."
  exit 127
}
