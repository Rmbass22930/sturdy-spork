Codex 5.3 (BallisticTarget) - New Projects Setup
================================================

Use this package to set Codex model `gpt-5.3-codex` for any new project.
...
- Sets both to model: gpt-5.3-codex
...
Notes
- `Start_Codex53.ps1` and `codex_profile.ps1` are optional project helpers.
- Codex 5.3 uses PowerShell 7+ (`pwsh`).
- If PowerShell is missing/outdated, run:
  run-install-powershell.cmd
- Codex 5.3 uses Python 3.
